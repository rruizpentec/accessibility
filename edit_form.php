...
class block_accessibility_edit_form extends block_edit_form {
    ...
    protected function specific_definition($mform) {
        ...
        // Colour schemes.
        for ($i = 2; $i < 5; $i++) {
            // This is how many declarations we defined in defaults.php get previously saved configuration.
            ...
            <div class="fitem" style="padding:10px 0 8px">
                ...
                <div class="felement">
                    <span style="padding:2px 8px;
                                 color:'.$fgcolour.';
                                 border:1px solid '.$fgcolour.';
                                 background:'.$bgcolour.' !important">A</span>
                    Colour scheme #'.$i.'
                </div>
            </div>');
