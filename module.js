M.block_accessibility = {
    ...
    */
    ...
    MAX_PX_FONTSIZE: 26,
    MIN_PX_FONTSIZE: 10 + 1, // Add 1 because of unknown error...YUI for 77% returns style of 11px.
    ...
    reload_stylesheet: function() {
        ...
        var basepath = '/blocks/accessibility/userstyles.php?instance_id=';
        var cssURL = M.cfg.wwwroot + basepath + M.block_accessibility.instance_id + '&v=' + cache_prevention_salt;
        ...
        if (document.createStyleSheet) { // Only for IE < 11 and IE > 8.
            ...
            */
            ...
            // Why wouldn't we just set the href attribute insted of creating another stylesheet node? Because before the new
            // stylesheet is loaded and while old one is deleted, the page will lose all the styles and all the elements get
            // unstyled for a some time (poor user experience).
    ...
    hide_loading: function() {
        if (this.transactionsCount < 0) {
            ...
            // Prevention if count would end up to less than 0.
